...
<div class="flex flex-1">
    ...
    <!-- Aside aqui -->
    <?= $forms->asideI('sidebar', 'hidden lg:flex flex-col fixed top-0 bottom-0 left-0 border-r border-gray-200 bg-white shadow-lg rounded-sm w-72 h-screen transition-all duration-300 z-50 overflow-hidden') ?>
            ...
            <ul class="flex flex-col gap-1">
                <li>
                    <a href="#" data-target="section-frames" class="sidebar-link flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 group">
                        ...
                        <span class="text-sm sidebar-text whitespace-nowrap transition-opacity duration-200">Painéis</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" data-target="section-empresas" class="sidebar-link flex items-center gap-2 px-3 py-2 rounded hover:bg-gray-100 group">
                        ...
                        <span class="text-sm sidebar-text whitespace-nowrap transition-opacity duration-200">Empresas</span>
                    </a>
                </li>
    ...
    <main class="flex-1 flex-col pb-10">
        ...
        <p class="text-sm text-muted-foreground text-shadow">Bem-vindo ao painel de controle. Gerencie suas configurações e preferências aqui.</p>
